    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Detail Shippings</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item active">Detail Shippings</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        ...
                        <div class="invoice p-3 mb-3">
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td align="center">
                                        <img src="{{ asset('assets/logo2.png') }}" width="90%">
                                    </td>
                                </tr>
                            </table>
                            <table width="100%" cellpadding="0" cellspacing="0" style="margin-left: 100px">
                                <tr>
                                    <td align="center">
                                        <table width="100%" cellpadding="0" cellspacing="0">
                                            <tr>
                            ...
                            <div class="row no-print">
                                <div class="col-12">
                                    <a href="{{ route('shippings.download', $shipping->id) }}" rel="noopener"
