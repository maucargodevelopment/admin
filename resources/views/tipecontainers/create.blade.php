    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Create Tipe Container</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item active">Create Tipe Container</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        <div class="card card-primary card-outline">
                            <div class="card-header">
                                <h3 class="card-title">Create Tipe Container</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                <!-- form start -->
                                <form role="form" method="post" action="{{ route('tipecontainers.store') }}">
                                    @csrf
                                    <div class="box-body">
                                        ...
                                        <div class="form-group @if ($errors->has('no_container')) has-error @endif">
                                            ...
                                            <input type="text" class="form-control" id="no_container" name="no_container"
                                                placeholder="Masukkan Nomor Kontainer" value="{{ old('no_container') }}">
                                        ...
                                        <div class="form-group @if ($errors->has('volume')) has-error @endif">
                                            ...
                                            <input type="text" class="form-control" id="volume" name="volume"
                                                placeholder="Masukkan Volume Kontainer" value="{{ old('volume') }}">
                                        ...
                                        <div class="form-group @if ($errors->has('vessel')) has-error @endif">
                                            ...
                                            <input type="text" class="form-control" id="vessel" name="vessel"
                                                placeholder="Masukkan Vessel Kontainer" value="{{ old('vessel') }}">
