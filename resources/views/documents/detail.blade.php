                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="form-group @if ($errors->has('freight')) has-error @endif">
                                                <label for="freight">Freight <strong>(Harus dicek lagi)</strong></label>
                                                <select class="form-control select2bs4 select2-hidden-accessible" style="width: 100%;" data-select2-id="17" tabindex="-1" aria-hidden="true" id="freight" name="freight">
                                                    <option value="PREPAID" {{$document->freight == 'PREPAID' ? 'selected' : ''}}>PREPAID</option>
                                                    <option value="COLLECT" {{$document->freight == 'COLLECT' ? 'selected' : ''}}>COLLECT</option>
                                                    <option value="OTHER" {{$document->freight == 'OTHER' ? 'selected' : ''}}>OTHER</option>
                                                </select>
                    ...
                    <form action="{{ route('containers.store') }}" method="POST">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <select class="form-control select2bs4 select2-hidden-accessible" style="width: 100%;" data-select2-id="17" tabindex="-1" aria-hidden="true" id="volume" name="volume" required>
                                <option value="20 Feet" {{ old('volume') == '20 Feet' ? 'selected': ''}}>20 Feet</option>
                                <option value="40 Std" {{ old('volume') == '40 Std' ? 'selected': ''}}>40 Std</option>
                                <option value="40 HC" {{ old('volume') == '40 HC' ? 'selected': ''}}>40 HC</option>
                                <option value="45 HC" {{ old('volume') == '45 HC' ? 'selected': ''}}>45 HC</option>
                                <option value="Air Freight" {{ old('volume') == 'Air Freight' ? 'selected': ''}}>Air Freight</option>
                                <option value="LCL" {{ old('volume') == 'LCL' ? 'selected': ''}}>LCL</option>
                                <option value="Courier" {{ old('volume') == 'Courier' ? 'selected': ''}}>Courier</option>
                            </select>
                        </div>
                        <div class="form-group col-md-12">
                            <label>Vessel</label>
