                                ...
                                <form role="form" method="post" action="{{ route('documents.update', $document->id) }}">
                                    ...
                                    <div class="form-group @if ($errors->has('freight')) has-error @endif">
                                        ...
                                        <select class="form-control select2bs4 select2-hidden-accessible" style="width: 100%;" data-select2-id="17" tabindex="-1" aria-hidden="true" id="freight" name="freight">
                                            <option selected="selected" data-select2-id="19" value="PREPAID">PREPAID</option>
                                            <option data-select2-id="66" value="COLLECT" >COLLECT</option>
                                            <option data-select2-id="67" value="OTHER" >OTHER</option>
                                        </select>
